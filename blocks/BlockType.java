...
public enum BlockType {
    ...
    // lanterns
    BLAZE(BlockIds.BLAZE_ID, "mob.blaze.breathe", BlockIds.BLAZETOP, BlockIds.BLAZEFRONT,
    ...
    WITCHSPAWN(BlockIds.WITCHSPAWN_UNLOCALIZED_NAME, null, BlockIds.WITCHSPAWNTOP, BlockIds.WITCHSPAWNSIDE,
            BlockIds.WITCHSPAWNSIDE, BlockIds.WITCHSPAWNSIDE, 66),

    GIANTSPAWN(BlockIds.GIANTSPAWN_UNLOCALIZED_NAME, null, BlockIds.GIANTSPAWNTOP, BlockIds.GIANTSPAWNSIDE,
            BlockIds.GIANTSPAWNSIDE, BlockIds.GIANTSPAWNSIDE, 53);
